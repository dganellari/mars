...
MODULES="modules cce daint-gpu PrgEnv-gnu slurm cdt-cuda cray-mpich cray-hdf5-parallel cray-netcdf-hdf5parallel cray-libsci cray-python craype-accel-nvidia60" #VTK
for m in ${MODULES} ; do
...
ENVBASE=/apps/daint/UES/anfink/gpu
...
BUILD_WITH_CUDA_SUPPORT="1" "${SCRIPTBASE}/mars.sh" "${BUILDBASE}/mars" "${INSTALLBASE}/mars" |& tee ${BUILDBASE}/mars/logfile
