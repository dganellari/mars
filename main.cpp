...
//   std::endl; std::cout << "n_nodes: " << mesh.n_nodes() << std::endl;
...
//   if (z < 100) {
//     std::cout << "build_cube" + std::to_string(x) + std::to_string(y) +
//     ".vtu"
//               << std::endl;
...
//   // auto edge_select = std::make_shared<UniqueLongestEdgeSelect<3,
//   3>>(true);
...
//     mark_hypersphere_for_refinement(mesh, {0.5, 0.5, 0.5, 0.5}, 0.25,
//     elements);
