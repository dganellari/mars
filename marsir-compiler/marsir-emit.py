#!/usr/bin/env python3
"""marsir-emit: compile an operator spec to an IR dump or GPU/host source.

    python3 marsir-emit.py specs/laplacian.op --backend ir
    python3 marsir-emit.py specs/laplacian.op --backend cuda -o generated/laplacian_apply.cuh
...
from marsir import parse_spec_file, synthesize, dump
from marsir.backends import cuda, host_cpp, mlir_ir
