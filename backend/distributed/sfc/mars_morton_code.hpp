...
namespace mars {
    ...
    uint64_t interleave_2D(uint64_t x) {
    ...
    MARS_INLINE_FUNCTION
    uint64_t compact_2D(uint64_t x) {
    ...
    MARS_INLINE_FUNCTION uint64_t interleave_3D(uint64_t a) {
    ...
    MARS_INLINE_FUNCTION uint64_t compact_3D(uint64_t n) {
    ...
    /* -------------------------Morton encoding/decoding in 32- and 64-bit using the magic number method---- */
    template <class KeyType>
    MARS_INLINE_FUNCTION std::enable_if_t<std::is_unsigned<KeyType>{}, KeyType> decode_morton_2DX(KeyType code) {
        return compact_2D(code);
    }

    template <class KeyType>
    MARS_INLINE_FUNCTION std::enable_if_t<std::is_unsigned<KeyType>{}, KeyType> decode_morton_2DY(KeyType code) {
        return compact_2D(code >> 1);
    }

    template <class KeyType>
    MARS_INLINE_FUNCTION std::enable_if_t<std::is_unsigned<KeyType>{}, KeyType> decode_morton_3DX(KeyType code) {
        return compact_3D(code);
    }

    template <class KeyType>
    MARS_INLINE_FUNCTION std::enable_if_t<std::is_unsigned<KeyType>{}, KeyType> decode_morton_3DY(KeyType code) {
        return compact_3D(code >> 1);
    }

    template <class KeyType>
    MARS_INLINE_FUNCTION std::enable_if_t<std::is_unsigned<KeyType>{}, KeyType> decode_morton_3DZ(KeyType code) {
