...
// FP64 tensor cores are warp-level mma.sync (m8n8k4) only: wgmma.mma_async has
// no FP64 variant in the PTX ISA, so there is no Hopper WGMMA fast path here.
// WMMA (below) is the correct FP64 path on every supported arch.
    // =========================================================================
