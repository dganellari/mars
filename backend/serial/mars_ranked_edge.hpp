...
namespace mars {
    ...
    public:
        ...
        RankedEdgeSelect(const Map &map, const bool online_update) : map(map), online_update(online_update) {}
        ...
        Integer select(const Mesh &mesh, const Integer element_id) const override {
            ...
            for (Integer i = 0; i < n_edges(e); ++i) {
                ...
                ranked_edges.emplace_back(Edge(map.global(v1), map.global(v2)), r, i);
            }
        ...
        virtual std::string name() const override { return "RankedEdgeSelect"; }
        ...
        bool element_is_ranked(const Mesh &mesh, const Integer element_id) const {
            const auto &e = mesh.elem(element_id);
        ...
        void init_uniform_ranking(const Mesh &mesh) {
            ...
            for (Integer i = 0; i < mesh.n_elements(); ++i) {
                ...
                for (Integer k = 0; k < n_edges(e); ++k) {
                    ...
                    edge_rank_.update(map.global(v1), map.global(v2), 1);
                }
            }
        ...
        void init_local_ranking(const Mesh &mesh) {
            ...
            for (Integer i = 0; i < mesh.n_elements(); ++i) {
                ...
                for (Integer k = 0; k < n_edges(e); ++k) {
                    ...
                    local_len.emplace_back(e_len, Edge(map.global(v1), map.global(v2)));
                }
                ...
                for (Integer k = 0; k < local_len.size(); ++k) {
                    ...
                    Edge local_edge(map.local(edge[0]), map.local(edge[1]));
        ...
        void init_ranking(const Mesh &mesh) {
            ...
            for (Integer i = 0; i < mesh.n_elements(); ++i) {
                ...
                for (Integer k = 0; k < n_edges(e); ++k) {
                    ...
                    global_edge_rank.update(map.global(v1), map.global(v2), INVALID_INDEX);
                }
            }
            ...
            for (Integer i = 0; i < ne; ++i) {
                ...
                Edge local_edge(map.local(e[0]), map.local(e[1]));
