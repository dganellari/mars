...
namespace mars {
    ...
    public:
        ...
        virtual ~EdgeSelect() {}
        virtual Integer select(const Mesh &mesh, const Integer element_id) const {
            // first edge selected
            return 0;
        }

        virtual Integer select(const Mesh &mesh, const Edge &neighbor_edge, const Integer element_id) const {
            // first edge selected
            return 0;
        }

        virtual Integer select(const Mesh &mesh,
        ...
        virtual Integer stable_select(const Mesh &mesh, const Integer element_id) const {
            // first edge selected
            return 0;
        }
