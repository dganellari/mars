...
namespace mars {
    ...
    public:
        ...
        static constexpr Integer NNodes = ManifoldDim + 1;
        ...
        inline Integer get_block() const override { return block; }

        inline void set_block(const Integer block_id) override { block = block_id; }
        ...
        inline Integer type() const override { return ManifoldDim + 1; }
        ...
        void side(const Integer &side_num, Simplex<Dim, ManifoldDim - 1> &side) const {
    ...
    void write(const Simplex<Dim, ManifoldDim> &simplex, OutputStream &os) {
    ...
    void read(Simplex<Dim, ManifoldDim> &simplex, InputStream &is) {
    ...
    void write(const Simplex<Dim, 1> &simplex, OutputStream &os) {
        write(&simplex.nodes[0], simplex.nodes.size(), os);
        write(&simplex.side_tags[0], simplex.side_tags.size(), os);
        write(simplex.id, os);
        write(simplex.parent_id, os);
    ...
    void read(Simplex<Dim, 1> &simplex, InputStream &is) {
        read(&simplex.nodes[0], simplex.nodes.size(), is);
        read(&simplex.side_tags[0], simplex.side_tags.size(), is);
        read(simplex.id, is);
        read(simplex.parent_id, is);
    ...
    public:
        ...
        inline Integer type() const override { return 0; }
    ...
    public:
        ...
        inline Integer type() const override { return 2; }
        ...
        void side(const Integer &side_num, Simplex<Dim, 0> &side) const { side.id = nodes[side_num]; }
    ...
    public:
        ...
        static constexpr Integer NNodes = 3;
        ...
        void side(const Integer &side_num, Simplex<Dim, 1> &side) const {
        ...
        Integer type() const override { return 3; }
    ...
    public:
        ...
        static constexpr Integer NNodes = 4;
        ...
        void side(const Integer &side_num, Simplex<Dim, 2> &side) const {
            switch (side_num) {
                case 0: {
        ...
        inline Integer type() const override { return 4; }
    ...
    public:
        ...
        static constexpr Integer NNodes = 5;
        ...
        void side(const Integer &side_num, Simplex<Dim, 3> &side) const {
        ...
        inline Integer type() const override { return 5; }
    ...
    template <Integer Dim, Integer ManifoldDim>
    Real in_sphere_radius(const Simplex<Dim, ManifoldDim> &simplex, const std::vector<Vector<Real, Dim>> &points) {
        Real areas = 0.;
    ...
    template <Integer Dim, Integer ManifoldDim>
    inline Real volume(const Simplex<Dim, ManifoldDim> &simplex, const std::vector<Vector<Real, Dim>> &points) {
        static_assert(Dim >= ManifoldDim, "Dim must be greater or equal ManifoldDim");
    ...
    template <Integer ManifoldDim>
    using SimplexInterpolator =
        Matrix<Real, ManifoldDim + 1 + Combinations<ManifoldDim + 1, 2>::value, ManifoldDim + 1>;
