...
namespace mars {
    ...
    public:
        ...
        virtual bool repair_element() override { return false; }
        ...
        virtual std::string name() const override { return "ImplicitOrderEdgeSelect"; }
    };

    template <class Mesh>
    class GlobalNewestVertexEdgeSelect final : public EdgeSelect<Mesh> {
    public:
        GlobalNewestVertexEdgeSelect(const Map &map, const bool recursive = true, const bool use_tollerance = true)
        ...
        virtual std::string name() const override { return "GlobalNewestVertexEdgeSelect"; }
    ...
    public:
        NewestVertexEdgeSelect(const bool recursive = true) : recursive_(recursive) {}
        ...
        virtual std::string name() const override { return "NewestVertex"; }
    ...
    public:
        ...
        virtual std::string name() const override { return "NewestVertexAndLongestEdge"; }
