...
namespace mars {
    class EdgeSplit {
    public:
        EdgeSplit(const Edge &edge = Edge(),
                  const Integer midpoint = INVALID_INDEX,
        ...
        inline bool is_valid() const { return edge.is_valid(); }
    ...
    void write(const EdgeSplit &edge_split, OutputStream &os) {
    ...
    void read(EdgeSplit &edge_split, InputStream &is) {
