...
namespace mars {
    ...
    //    		os << "<DataArray type=\"" << _numericType << "\" Name=\"" << _name << "\"
    //    NumberOfComponents=\""
    ...
    public:
        ...
        void writeCells(const Mesh &mesh, std::ostream &os) {
            ...
            os << "<DataArray type=\"UInt8\" Name=\"types\" format=\"ascii\" RangeMin=\"" << minTag << "\" RangeMax=\""
               << maxTag << "\">\n";
            ...
            for (Integer i = 0, offset = (mars::n_nodes(mesh.elem(0))); i < n_active_elements;
                 ++i, offset += (mars::n_nodes(mesh.elem(0)))) {
                os << offset << "\n";
            }
