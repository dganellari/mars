...
// template<typename T,Integer Rows,Integer Cols>
// class Transposed<Matrix<T,Rows,Cols>> 
// {    
//  public:     
...
//  inline static void apply(Output& A,const Matrix<T,Rows,Cols>& B)
//   {
//     Assignment<Matrix<T,Rows,Cols>>::apply(A,B);
//     std::cout<<"Transposed<Matrix<T,Rows,Cols>> "<<std::endl;
//   };
...
// class Transposed<QPValues<U,NQPoints>> 
// {       
//  public:               
//  template<typename V>
...
//         {
//           std::cout<<"pre Transposed QPValues"<<std::endl;
//           Transposed<U>::apply(A[qp],B[qp]);
//         }
//   };
// };
...
// class Transposed<FQPValues<U,NQPoints,Ndofs>> 
// {       
//  public:               
//  template<typename V>
...
//      for(Integer qp=0;qp<NQPoints;qp++)
//        {
//         Transposed<U>::apply(A(n_dof,qp),B(n_dof,qp));
//        }
//   };
// };
...
class Evaluation<Expression<Unary<Expression<Derived> > >,OtherTemplateArguments...>
{
 ...
 void apply(outputsubtype& output,const Inputs&...inputs)
 {
  ...
  std::cout<<"after MINUS Evaluation<Expression<UnaryOperator "<<std::endl;
  std::cout<<"derived_value_="<<derived_value_<<std::endl;
  std::cout<<"output="<<output<<std::endl;
  // apply minus to output
  // Minus(output,tmp);
