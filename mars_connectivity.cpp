...
template class Connectivity<2,3,0,0,0>;
template class Connectivity<2,3,1,0,0>;
template class Connectivity<2,3,2,0,0>;
template class Connectivity<2,3,3,0,0>;
// mesh 2D  Sub=Edge, To=Node
template class Connectivity<2,3,0,1,0>;
template class Connectivity<2,3,1,1,0>;
template class Connectivity<2,3,2,1,0>;
template class Connectivity<2,3,3,1,0>;
// mesh 2D  Sub=Triangle, To=Node
template class Connectivity<2,3,0,2,0>;
template class Connectivity<2,3,1,2,0>;
template class Connectivity<2,3,2,2,0>;
template class Connectivity<2,3,3,2,0>;
// mesh 2D  Sub=Tetrahedron, To=Node
template class Connectivity<2,3,0,3,0>;
template class Connectivity<2,3,1,3,0>;
template class Connectivity<2,3,2,3,0>;
template class Connectivity<2,3,3,3,0>;

// mesh 2D  Sub=Node, To=Edge
template class Connectivity<2,3,0,0,1>;
template class Connectivity<2,3,1,0,1>;
template class Connectivity<2,3,2,0,1>;
template class Connectivity<2,3,3,0,1>;
// mesh 2D  Sub=Edge, To=Edge
template class Connectivity<2,3,0,1,1>;
template class Connectivity<2,3,1,1,1>;
template class Connectivity<2,3,2,1,1>;
template class Connectivity<2,3,3,1,1>;
// mesh 2D  Sub=Triangle, To=Edge
template class Connectivity<2,3,0,2,1>;
template class Connectivity<2,3,1,2,1>;
template class Connectivity<2,3,2,2,1>;
template class Connectivity<2,3,3,2,1>;
// mesh 2D  Sub=Tetrahedron, To=Edge
template class Connectivity<2,3,0,3,1>;
template class Connectivity<2,3,1,3,1>;
template class Connectivity<2,3,2,3,1>;
template class Connectivity<2,3,3,3,1>;



// mesh 2D  Sub=Node, To=Triangle
template class Connectivity<2,3,0,0,2>;
template class Connectivity<2,3,1,0,2>;
template class Connectivity<2,3,2,0,2>;
template class Connectivity<2,3,3,0,2>;
// mesh 2D  Sub=Edge, To=Triangle
template class Connectivity<2,3,0,1,2>;
template class Connectivity<2,3,1,1,2>;
template class Connectivity<2,3,2,1,2>;
template class Connectivity<2,3,3,1,2>;
// mesh 2D  Sub=Triangle, To=Triangle
template class Connectivity<2,3,0,2,2>;
template class Connectivity<2,3,1,2,2>;
template class Connectivity<2,3,2,2,2>;
template class Connectivity<2,3,3,2,2>;
// mesh 2D  Sub=Tetrahedron, To=Triangle
template class Connectivity<2,3,0,3,2>;
template class Connectivity<2,3,1,3,2>;
template class Connectivity<2,3,2,3,2>;
template class Connectivity<2,3,3,3,2>;

// mesh 2D  Sub=Node, To=Tetrahedron
template class Connectivity<2,3,0,0,3>;
template class Connectivity<2,3,1,0,3>;
template class Connectivity<2,3,2,0,3>;
template class Connectivity<2,3,3,0,3>;
// mesh 2D  Sub=Edge, To=Tetrahedron
template class Connectivity<2,3,0,1,3>;
template class Connectivity<2,3,1,1,3>;
template class Connectivity<2,3,2,1,3>;
template class Connectivity<2,3,3,1,3>;
// mesh 2D  Sub=Triangle, To=Tetrahedron
template class Connectivity<2,3,0,2,3>;
template class Connectivity<2,3,1,2,3>;
template class Connectivity<2,3,2,2,3>;
template class Connectivity<2,3,3,2,3>;
// mesh 2D  Sub=Tetrahedron, To=Tetrahedron
template class Connectivity<2,3,0,3,3>;
template class Connectivity<2,3,1,3,3>;
template class Connectivity<2,3,2,3,3>;
template class Connectivity<2,3,3,3,3>;
