...
namespace mars {
    ...
    public:
        ...
        public:
            ...
            MARS_INLINE_FUNCTION static void affine_f(const int i, const T *J_inv, const Point &p, Vector &g) {
                T gi[2];
            ...
            MARS_INLINE_FUNCTION static void ref(const Point &q, const T *u, Vector &g) {
                T gi[2];
