  ...
  SharedMemView<double*, HostShmem>& err)
{
  ...
  STK_NGP_ThrowRequireMsg(3 == deriv.extent(2),
                          "tet_gradient_operator: Error in derivative array");

  const unsigned nelem = cordel.extent(0);
  STK_NGP_ThrowRequireMsg(npe == cordel.extent(1),
                          "tet_gradient_operator: Error in coorindate array");
  STK_NGP_ThrowRequireMsg(3 == cordel.extent(2),
                          "tet_gradient_operator: Error in coorindate array");

  STK_NGP_ThrowRequireMsg(nint == gradop.extent(0),
                          "tet_gradient_operator: Error in gradient array");
  STK_NGP_ThrowRequireMsg(nelem == gradop.extent(1),
                          "tet_gradient_operator: Error in gradient array");
  STK_NGP_ThrowRequireMsg(npe == gradop.extent(2),
                          "tet_gradient_operator: Error in gradient array");
  STK_NGP_ThrowRequireMsg(3 == gradop.extent(3),
                          "tet_gradient_operator: Error in gradient array");

  STK_NGP_ThrowRequireMsg(nint == det_j.extent(0),
                          "tet_gradient_operator: Error in determinent array");
  STK_NGP_ThrowRequireMsg(nelem == det_j.extent(1),
                          "tet_gradient_operator: Error in determinent array");

  STK_NGP_ThrowRequireMsg(nelem == err.extent(0),
                          "tet_gradient_operator: Error in error array");
