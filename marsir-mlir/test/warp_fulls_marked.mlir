...
gpu.module @mir_kernels [#nvvm.target<chip = "sm_90", O = 3>] {
  gpu.func @full(%u: memref<8x8x8xf64> {mir.element}, %Btil: memref<8x8xf64>, %Dtil: memref<8x8xf64>, %Dm: memref<8x8xf64>, %W: memref<8x8xf64>, %g00all: memref<8x8x8xf64> {mir.element}, %g01all: memref<8x8x8xf64> {mir.element}, %g02all: memref<8x8x8xf64> {mir.element}, %g10all: memref<8x8x8xf64> {mir.element}, %g11all: memref<8x8x8xf64> {mir.element}, %g12all: memref<8x8x8xf64> {mir.element}, %g20all: memref<8x8x8xf64> {mir.element}, %g21all: memref<8x8x8xf64> {mir.element}, %g22all: memref<8x8x8xf64> {mir.element}, %y3: memref<8x8x8xf64> {mir.element}) workgroup(%interp_all: memref<8x64xf64, #gpu.address_space<workgroup>>, %deriv_all: memref<8x64xf64, #gpu.address_space<workgroup>>, %flux: memref<8x8xf64, #gpu.address_space<workgroup>>, %tmp: memref<8x8xf64, #gpu.address_space<workgroup>>, %intf: memref<8x8xf64, #gpu.address_space<workgroup>>) kernel {
