...
// CHEAP per-element metric (warp_batched_affine_sm90.ptx): g{d}{c} are Exnxn
...
int main(int argc, char** argv)
{
    ...
    *(void**)&p_cuGetErrorString = sy(lib,"cuGetErrorString");
    ...
    const char* ptxPath = argc > 1 ? argv[1] : "../generated/warp_batched_affine_sm90.ptx";
    ...
    CUfunction fn; CK(p_cuModuleGetFunction(&fn, mod, "full_batched_affine"));
