// GPU gate for the REGISTER-RESIDENT single face (warp_face_reg): direct
// per-lane mma + gpu.shuffle relayout, NO shared memory, NO barriers
// (warp_face_reg_sm90.ptx): the operator's repeating unit -- 4 contracts + the
...
// Run:    ./run_face ../generated/warp_face_reg_sm90.ptx
...
int main(int argc, char** argv)
{
    ...
    *(void**)&p_cuGetErrorString    = must_sym(lib, "cuGetErrorString");
    ...
    const char* ptxPath = argc > 1 ? argv[1] : "../generated/warp_face_reg_sm90.ptx";
    ...
    CUfunction fn; CK(p_cuModuleGetFunction(&fn, mod, "face_reg"));
    ...
    printf("REGISTER-RESIDENT face-chain gate: max|intf - W@((g2*deriv+g0*dt2+g1*dt1)@W^T)| = %.3e  %s\n",
