/*
#ifndef MARS_LEPP_BISECTION_KOKKOS_HPP_
#define MARS_LEPP_BISECTION_KOKKOS_HPP_
...
class ParallelLeppBisection: public Bisection<Mesh_> {
...
public:
	...
	ParallelLeppBisection(Mesh &mesh) :
			Bisection<Mesh>(mesh) {
