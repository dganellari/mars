...
namespace mars {
    ...
    template <Integer Dim, Integer ManifoldDim>
    MARS_INLINE_FUNCTION constexpr static Integer n_nodes(
        const Simplex<Dim, ManifoldDim, DistributedImplementation> &) {
        return ManifoldDim + 1;
    }

    template <Integer Dim, Integer ManifoldDim>
    MARS_INLINE_FUNCTION constexpr static Integer n_sides(
        const Simplex<Dim, ManifoldDim, DistributedImplementation> &) {
        return ManifoldDim + 1;
    }
    ...
    template <Integer Dim, Integer ManifoldDim>
    MARS_INLINE_FUNCTION constexpr static Integer n_edges(
        const Simplex<Dim, ManifoldDim, DistributedImplementation> &) {
