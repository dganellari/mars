...
# MARS Find Module
#
# Usage: Control the search through MARS_DIR.
#
# Following variables are set: MARS_FOUND            (BOOL)               Flag
# indicating if MARS was found MARS_INCLUDES         (LIST of PATH)       Path
# to the MARS include file MARS_DEFS             (LIST)               List with
# all defs for the compiler MARS_LIBRARIES        (LIST)               List of
# all required MARS libraries
#
# ##############################################################################
...
# PATH_SUFFIXES config NO_DEFAULT_PATH)

# if(MARS_CONFIG_FILE_PATH) include(${MARS_CONFIG_FILE_PATH}/mars_config.cmake)
# endif()

# Send useful message if everything is found
find_package_handle_standard_args(MARS DEFAULT_MSG MARS_LIBRARIES MARS_INCLUDES)
