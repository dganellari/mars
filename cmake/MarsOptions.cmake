...
# Mirage (MARS FEM operator IR; MIR = MARS Intermediate Representation): build
# the parity example for kernels generated by mirage-compiler/ from an operator
# spec. Generated kernels live under backend/distributed/unstructured/mirage/generated/;
# the compiler itself is a separate build-time tool and is NOT a MARS build
# dependency. OFF by default.
option(MARS_ENABLE_MIRAGE "Build the Mirage generated-kernel parity example (requires UNSTRUCTURED + CUDA)" OFF)
