...
def prepare(interior, boundary, updates, output):
    ...
    out.write('MARS_PUBLIC_SIMPLE_V1 425 1536 576 2\n')
...
if __name__ == '__main__':
    ...
    try: prepare(args.interior,args.boundary,args.updates,args.output)
